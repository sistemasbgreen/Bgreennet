...
public class MetaRepository {
    ...
    public List<ProductoDTO> obtenerProductos() {
        ...
        for (ProductoDTO p : productosMap.values()) {
            System.out.println("DEBUG LOADED PRODUCT: id=" + p.getId() + ", siesa=" + p.getIdProductoSiesa() + ", nombre=" + p.getNombre() + ", operators=" + p.getFormulaOperadores() + ", consumoDocs=" + p.getConsumptionDocTypes());
        }
