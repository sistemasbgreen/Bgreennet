...
export class CmiHome implements OnInit, OnDestroy {
  ...
  constructor(private plantaService: cmiplantaservices) {}
  ...
  configurarGraficos(): void {
    ...
    // Opciones para gráficos mensuales de CxP
    ...
    // Opciones para gráficos mensuales de PxC
